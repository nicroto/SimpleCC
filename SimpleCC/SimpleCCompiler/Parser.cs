    ...
    class Parser
    {
        ...
        private bool IsAdditiveExpression(BitwiseExpression bitwiseExpression)
        {
            ...
            while (true)
            {
                ...
                {
                    additiveExpression.Operations.Add(AdditiveOperations.Summation);
                }
                else if (CheckSpecialSymbol("-"))
                {
                    additiveExpression.Operations.Add(AdditiveOperations.Subtraction);
                }
                else
                {
                    break;
        ...
        private bool IsMultiplicativeExpression(AdditiveExpression additiveExpression)
        {
            ...
            while (true)
            {
                if (CheckSpecialSymbol("*"))
                {
                    multiplicativeExpression.Operations.Add(MultiplicativeOperations.Multiplication);
                }
                else if (CheckSpecialSymbol("/"))
                {
                    multiplicativeExpression.Operations.Add(MultiplicativeOperations.Division);
                }
                else if (CheckSpecialSymbol("%"))
                {
                    multiplicativeExpression.Operations.Add(MultiplicativeOperations.Percentage);
                }
                else
                {
                    break;
